...
class GradescopeCalendar:
    ...
    active_cid: list 
        Only gets assignments from selected CID Courses
    ...
    def __init__(self, email: str, password: str, is_instructor: bool = False, active_cid: list = []) -> None:
    ...
    def _get_calendar_info(self) -> None:
        ...
        session.account.add_courses_in_account(self.is_instructor, self.active_cid)
    ...
    # Change: add GCAL_ID Support 
    def write_to_gcal(self, gcal_id: str = None) -> None:
        self.gcal_id = gcal_id
        self.gcal = GCal()
        self.gcal.write_to_gcal(self.assignments_all, self.gcal_id)
